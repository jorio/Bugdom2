...
game_name           = "Bugdom2"  # no spaces
game_name_human     = "Bugdom 2"  # spaces and other special characters allowed
game_package        = "io.jor.bugdom2"  # unique package name
game_ver            = "4.0.0"

source_check        = "Source/Items/Chipmunk.c"  # some file that's likely to be from the game's source tree
...
class Project:
    ...
    def copy_documentation(self, appdir, full=True):
        ...
        if full:
            shutil.copytree("Instructions", f"{appdir}/Instructions")
