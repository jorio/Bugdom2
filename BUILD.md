...
1. Clone the repo **recursively**:
    ...
    cd Bugdom2
    ```
1. Download [SDL2-2.28.3.dmg](https://libsdl.org/release/SDL2-2.28.3.dmg), open it, and copy **SDL2.framework** to the **extern** folder
...
1. Clone the repo **recursively**:
    ...
    cd Bugdom2
    ```
1. Download [SDL2-devel-2.28.3-VC.zip](https://libsdl.org/release/SDL2-devel-2.28.3-VC.zip), extract it, and copy **SDL2-2.28.3** to the **extern** folder
